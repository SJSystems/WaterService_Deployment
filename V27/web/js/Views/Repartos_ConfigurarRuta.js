...
var Modelo = {
    ...
    Init: function () {
        ...
        $("#cmb_repartos").val(getParameterByName("reparto_id"));
    ...
    , ObtenerDatosDeReparto: function () {
        ...
        window.location.href = GetCurrentURLRoot() + "/Repartos/ConfigurarRuta?reparto_id=" + $("#cmb_repartos").val() + "&dia_id=" + $("#cmb_dias").val();
    }
