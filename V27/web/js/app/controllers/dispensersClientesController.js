...
mainApp.controller('dispensersClienteCtrl', ['$scope', '$http', '$uibModal', 'dispensersService',
        function ($scope, $http, $uibModal, dispensersService) {
            ...
            $scope.AbrirDialogo_AgregarDispenser = function () {

                var onSeleccionarDispensers = function (haConfirmado, dispensersSeleccionados) {

                    if (haConfirmado && dispensersSeleccionados != null) {
                        $scope.ConfirmarAgregarDispensers(dispensersSeleccionados.map(function (x) { return x.id; }),
                            $scope.modelo.abono_id);
                    }
                };
            ...
            $scope.ConfirmarAgregarDispensers = function (idsDispensers) {
