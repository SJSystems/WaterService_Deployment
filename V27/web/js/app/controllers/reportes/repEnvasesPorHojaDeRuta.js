...
mainApp.controller('repEnvasesPorHojaDeRutaController', ['$scope', '$http',
        function ($scope, $http) {
            ...
            $scope.buscar = function () {
                ...
                $http.post(GetUrlForService("/Reportes/ObtenerEnvasesPorHojaDeRuta"),
                {
            ...
            $scope.descargarExcel = function () {
                ...
                $http.post(GetUrlForService("/Reportes/ObtenerEnvasesPorHojaDeRutaExcel"),
                 {
                     fechaDesde: $scope.desdeHasta.startDate,
                     fechaHasta: $scope.desdeHasta.endDate,
                     repartidorId: $scope.repartidorSeleccionado == null ? null : $scope.repartidorSeleccionado.usuario_id,
