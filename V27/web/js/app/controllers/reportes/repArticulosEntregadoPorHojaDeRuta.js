...
mainApp.controller('repArticulosEntregadoPorHojaDeRutaController', ['$scope', '$http',
        function ($scope, $http) {
            ...
            $scope.buscar = function () {
                ...
                $http.post(GetUrlForService("/Reportes/ObtenerArticulosEntregadosPorHojaDeRuta"),
                {
            ...
            $scope.descargarExcel = function () {
                ...
                $http.post(GetUrlForService("/Reportes/ObtenerArticulosEntregadosPorHojaDeRutaExcel"),
                 {
                     fechaDesde: $scope.desdeHasta.startDate,
                     fechaHasta: $scope.desdeHasta.endDate,
                     repartidorId: $scope.repartidorSeleccionado == null ? null : $scope.repartidorSeleccionado.usuario_id,
